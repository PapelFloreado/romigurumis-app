    ...
    <div className='flex flex-col container mx-auto mt-16'>
        ...
        <div className='flex container mx-auto  justify-center w-1/3 mt-16 shadow-2xl shadow-banner-color rounded-xl'>
            <form ref={form} onSubmit={sendEmail} className='flex flex-col mt-10 items-center mx-auto justify-center w-full' action="">
                ...
                <input className='bg-white mb-6 w-1/2 text-2xl  border-solid  border-slate-700 border-2 rounded-xl p-2'  placeholder='Apellido' type="text" name="lastName" required/>
                <label className='text-2xl text-center' htmlFor="email">Email</label>
                <input className='bg-white mb-6 w-1/2 text-2xl  border-solid  border-slate-700 border-2 rounded-xl p-2' placeholder='Email' type="email" name="email" required/>
                <label className='text-2xl text-center' htmlFor="message">Dejanos tu mensaje</label>
