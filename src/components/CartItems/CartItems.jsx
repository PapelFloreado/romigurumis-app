    ...
    <div className='  min-h-[450px] mt-20'>
        ...
        <div>
            ...
            <div className=' mt-48 flex container mx-auto items-center justify-around  w-1/2'>
                ...
                <button className='rounded-xl text-2xl mx-6  text-button-card  font-bold   hover:bg-emerald-800 ease-in-out transition-colors duration-300 bg-banner-color px-8' onClick={clear}>Terminar Compra</button>
